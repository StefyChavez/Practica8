...
public class Dignidad {
    ...
    public Dignidad(int codigo, String cargoPolitico, int nMesas, String parroquian, String canton) {
        this.codigo = codigo;
    ...
    public String toString() {
        return "Dignidad{" + "codigo=" + codigo + ", cargoPolitico=" + cargoPolitico + ", nMesas=" + nMesas + ", parroquian=" + parroquian + ", canton=" + canton + '}';
    }
